/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 0f47a3e8c6953457ee27ea52db57f819)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		ASSETS?: Fetcher;
		WORKER_SELF_REFERENCE?: Fetcher /* my-lab */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "NEXT_PUBLIC_API_BASE_URL">> {}
}
