...
export default function Dock() {
  ...
  return (
    <aside className="fixed left-5 top-1/2 z-50 hidden -translate-y-1/2 md:block">
      <nav className="group w-14 overflow-hidden rounded-2xl bg-background transition-[width] duration-400 ease-[cubic-bezier(0.16,1,0.3,1)] hover:w-50 hover:shadow-[10px_0_30px_rgba(0,0,0,0.2)]">
