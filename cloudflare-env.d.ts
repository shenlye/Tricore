/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 2cd5a2c63187082ac4a0d4bbf8cc2ac3)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		ASSETS: Fetcher;
		NEXT_PUBLIC_API_BASE_URL: "https://api.shenley.top";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_API_BASE_URL" | "ALLOWED_ORIGINS" | "NEXTJS_ENV">> {}
}
